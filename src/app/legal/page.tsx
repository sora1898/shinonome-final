  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        <div className="bg-white/85 backdrop-blur-xl rounded-3xl p-10 md:p-16 shadow-2xl border border-white/50">
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <tbody className="divide-y divide-gray-200">
                <tr>
                  <th className="text-left py-5 px-8 w-1/3 bg-white/50 font-light text-gray-700 tracking-wide">販売事業者</th>
                  <td className="py-5 px-8 text-gray-600 font-light">Shinonome Study Group</td>
                </tr>
                <tr>
                  <th className="text-left py-4 px-6 bg-white/50 font-semibold text-gray-900">運営責任者</th>
                  <td className="py-5 px-8 text-gray-600 font-light">代表者</td>
                </tr>
                <tr>
                  <th className="text-left py-4 px-6 bg-white/50 font-semibold text-gray-900">所在地</th>
                  <td className="py-5 px-8 text-gray-600 font-light">（ご請求があれば遅滞なく開示します）</td>
                </tr>
                <tr>
                  <th className="text-left py-4 px-6 bg-white/50 font-semibold text-gray-900">メールアドレス</th>
                ...
                <tr>
                  <th className="text-left py-4 px-6 bg-white/50 font-semibold text-gray-900">販売価格</th>
                  <td className="py-5 px-8 text-gray-600 font-light">各商品ページに記載</td>
                </tr>
                <tr>
                  <th className="text-left py-4 px-6 bg-white/50 font-semibold text-gray-900">商品代金以外の必要料金</th>
                  <td className="py-5 px-8 text-gray-600 font-light">インターネット接続料金等はお客様のご負担となります</td>
                </tr>
                <tr>
                  <th className="text-left py-4 px-6 bg-white/50 font-semibold text-gray-900">お支払い方法</th>
                  <td className="py-5 px-8 text-gray-600 font-light">クレジットカード、その他決済方法</td>
                </tr>
                <tr>
                  <th className="text-left py-4 px-6 bg-white/50 font-semibold text-gray-900">商品の引渡時期</th>
                  <td className="py-5 px-8 text-gray-600 font-light">決済完了後、即時ダウンロード可能</td>
                </tr>
                <tr>
                  <th className="text-left py-4 px-6 bg-white/50 font-semibold text-gray-900">返品・キャンセル</th>
